...
typedef struct _FaceFlags {
    ...
    int32_t resv2;
    char userParam[68];
/* @@protoc_insertion_point(struct:FaceFlags) */
} FaceFlags;
...
#define FaceFlags_init_default                   {"", "", 0, 0, 0, 0, 0, 0, 0, 0, ""}
#define Picture_init_default                     {"", 0, 0, 0, ""}
#define AddFcae_init_default                     {FaceFlags_init_default, Picture_init_default}
#define FaceRecord_init_default                  {FaceFlags_init_default, Picture_init_default, DeviceId_init_default, 0, 0, 0, 0, 0, 0}
...
#define FaceFlags_init_zero                      {"", "", 0, 0, 0, 0, 0, 0, 0, 0, ""}
#define Picture_init_zero                        {"", 0, 0, 0, ""}
#define AddFcae_init_zero                        {FaceFlags_init_zero, Picture_init_zero}
#define FaceRecord_init_zero                     {FaceFlags_init_zero, Picture_init_zero, DeviceId_init_zero, 0, 0, 0, 0, 0, 0}
#define OperationFaceId_init_zero                {DeviceId_init_zero, "", 0}

/* Field tags (for use in manual encoding/decoding) */
#define DeviceId_dev_tag                         1
#define FaceFlags_faceID_tag                     1
#define FaceFlags_faceName_tag                   2
#define FaceFlags_role_tag                       3
#define FaceFlags_wgCardNO_tag                   4
#define FaceFlags_effectTime_tag                 5
#define FaceFlags_effectStartTime_tag            6
#define FaceFlags_version_tag                    7
#define FaceFlags_wgCardNOLong_tag               8
#define FaceFlags_ScheduleMode_tag               9
#define FaceFlags_resv2_tag                      10
#define FaceFlags_userParam_tag                  11
...
extern const pb_field_t FaceFlags_fields[12];
